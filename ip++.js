...
exports.prev = function ipminusminus(ip,options) {
  switch (net.isIP(ip)) {
    case 0 :
      return ip;
      break;
    case 4 :
      return ipminusminusv4(ip);
      break;
    case 6 :
      return ipminusminusv6(ip,options)
  };
}
...
function ipminusminusv6(ip,options) {
